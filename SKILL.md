...
3. **Integrate (the global workspace).** Bring the whole self into one view and check each organ's standing:
   ...
   - **Goal/self-model** — am I still pointed at the objective? Drifting? Done?
